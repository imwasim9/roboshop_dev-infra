...
# stop the ec2 instance to take the image
...
resource "aws_autoscaling_policy" "catlogue"{
...
resource "terraform_data" "catalogue_local"{
  ...
  depends_on = [aws_autoscaling_policy.catlogue]
